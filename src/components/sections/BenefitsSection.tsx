...
const benefits = [
  {
    ...
    desc: "Nunca mais repita aula. Tenha sempre uma atividade nova, divertida e envolvente.",
    color: "bg-primary/10 text-primary",
  },
  {
    icon: Users,
    title: "Mais Retenção (e Turmas Cheias)",
    desc: "Alunos que se divertem continuam. Aumente a permanência e evite desistências.",
    color: "bg-emerald-500/10 text-emerald-500",
  },
  {
    icon: Heart,
    title: "Funciona com Qualquer Aluno",
    desc: "Use com crianças, jovens ou adultos — do básico ao avançado, sem adaptação complexa.",
    color: "bg-rose-500/10 text-rose-500",
  },
  {
    icon: Zap,
    title: "Aplicação Imediata (Sem Planejar)",
    desc: "Abra, escolha a atividade e aplique na hora. Simples, rápido e eficiente.",
    ...
    <div className="container">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg sm:max-w-2xl mx-auto">
        {benefits.map((b, i) => (
          ...
          >
            <div
              className={`w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3 ${b.color.split(" ")[0]}`}
            >
